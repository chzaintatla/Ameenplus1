...
Map<String, String> _calculatePrayerTimes(double latitude, double longitude, DateTime date) {
  ...
  // In production, use a proper library like adhan or prayer_times
  ...
  // Approximate times (should be replaced with proper calculation)
  return {
    'fajr': '05:30',
    'dhuhr': '12:30',
    'asr': '15:45',
...
class PrayerTimesScreen extends ConsumerWidget {
  ...
  bool _isNextPrayer(Map<String, String> prayerTimes, String currentTime, int index) {
    ...
    // If no prayer found today, next is Fajr (first prayer)
    return index == 0;
  }
